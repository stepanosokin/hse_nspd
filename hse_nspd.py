                ...
                for i in range(i_from, i_to + 1, pixel_step):
                    ...
                    for j in range(j_from, j_to + 1, pixel_step):
                        ...
                        if auth_access_token_expires_dt <= cur_datetime_utc + timedelta(minutes=10):
                            ...
                            auth_access_token_expires_dt = cur_datetime_utc + timedelta(seconds=int(refreshed_auth.get('expires_in')) or 1800)
...
if __name__ == '__main__':
    ...
    if True:
        ...
        nspd_layers = [
            ...
            {"shortname": "егрн", "id": "36048", "fullname": "Земельные участки из ЕГРН"}
        ]
        ...
        access_token = 'eyJhbGciOiJSUzI1NiIsImtpZCI6IjEifQ.eyJhdWQiOiIwMzM4NmRiZS01MTg1LTRiOTYtOTAwZC1jMmIxYmIzNjhlZDYiLCJjbGllbnRfaWQiOiIwMzM4NmRiZS01MTg1LTRiOTYtOTAwZC1jMmIxYmIzNjhlZDYiLCJkaXNwbGF5X25hbWUiOiLQntGB0L7QutC40L0g0KHRgtC10L__.0oeDbi6-L-5rtQZ6YCO9rrRh_1f3CSqQ-iBXAijPMvH0ddRTuUKjF0uT27dtkkwAlvKgkX3ExpHHiHe3amFCBy3nUT3N7HORDQ5MnEUfWLml2JvJsIjstgmK20c5BLXDukMy5zSacWvaSmPRKHDg3LirQDQI6h9CEf1HaRHEqiCGjN-O_gnIKyiWa-_oAlOqKt0-BUeW0l_8UZj-8kFmuDQjCr5Jc-cLtXhJmkBDJ0Dd3LRiu-MPGv1tIAXFlMRR47m0yWBqIFrRRYI3uYqcfkt5NhpypMktiYWcqGPmXwnYLxwR3v8-ogBFhEskZnK2ST_otYuXUiKvGsdyd-rmUza-eGvcgs33y-BaqM3B_RR5uGvAJWpQpkWbAgDKFOw5BvIj8Aw39S2cl8iKylMb7DeXp_7bT6K06EbH4W-dZgoecpr1AvKmsuKmqT09c4qAJR0tzavhGBRNhcNF2NQSIlgFoAvK38vQx345CrUHx8lYVD8mYMm3_dRXX0ShxKm9-ktg6UtA19DU0RW2Y9NR08OUCkZ6ryPTGOjxlySGAI2u5YPYqWEgOGI0i8hM8RjrnN8qZPAP1mT7peStI-CXwum71NeeVYJeme6a9Zi5Dqn8ClPQmNmYKHSYTGhGmTxP9nYHFW05ZOP6j4odIVViApg-gKNCOCNsU9pp_ozS-MI'
        auth_access_token_expires = '%222026-06-24T06%3A50%3A35.910Z%22'
        refresh_token = 'c7QvsnuzMcUF7giQoF2qrXFZSqb4bbC2DsSBUXBOCNyZp4WltyNrfAFBbc69PMz7meUxHRsQWlMgKUVr4F'    
        ...
        for layer in nspd_layers:
            ...
            access_token, refresh_token, auth_access_token_expires = download_nspd_layer(
                ...
                tiles_gpkg='tiles.gpkg',
                tiles_layer='bykovo-gaz',                        # В Geopackage должен быть этот слой с тайлами
                width=256, height=256,                      # рекомендованные значения для размера тайла 128x128
                i_from=0, i_to=256, j_from=0, j_to=256,     # в общем случае, должно совпадать с widht и height
                pixel_step=1,                               # Для ХМАО рекомендовано 9. Для регионов поменьше можно 3.
